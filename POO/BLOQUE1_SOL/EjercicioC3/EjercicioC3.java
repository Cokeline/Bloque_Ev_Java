...
public class EjercicioC3 {
    public static void main(String[] args) {
        ...
        System.out.println("Coordenadas del rectángulo 1 (" + rec1.getX1() + "," + rec1.getY1() + ") y (" + rec1.getX2()
                + "," + rec1.getY2() + ")");
        System.out.println("Coordenadas del rectángulo 2 (" + rec2.getX1() + "," + rec2.getY1() + ") y (" + rec2.getX2()
                + "," + rec2.getY2() + ")");
